...
<!-- LOGOS -->
<div align="center">
  <a href="https://github.com/Alexi5000"><img src="assets/ac_logo.png" width="72" alt="AC Logo"></a>
  &nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://alexcinovoj.dev"><img src="assets/techtide_logo.png" width="200" alt="TechTide AI Logo"></a>
</div>
...
*Most teams can prompt Claude. Few can ship it.*
*I close that gap — from stuck prototype to live, observable, production-grade agent.*
...
<!-- Primary: Anthropic-native toolchain -->
...
| [**Bri**](https://github.com/Alexi5000/Bri) | Conversational agent scaffold built on Claude + MCP — video analysis, memory, transcription |
...
| [**CipherClaw**](https://github.com/Alexi5000/CipherClaw) | OpenClaw debug agent — traces causes, profiles behavior, predicts failures in multi-agent systems |
| [**ClawKeeper**](https://github.com/Alexi5000/ClawKeeper) | Autonomous AI bookkeeping — 110 agents handle invoices, reconciliation, and financial reporting |
...
**Automation Vibes** — cutting through AI hype to talk about what actually ships. Real systems, real logs, real outcomes. No demos without a production counterpart.
...
If your team has a Claude initiative that's blocked — stuck in prototype, failing in prod, or not observable enough to trust — that's the problem I solve. I come in, diagnose the system, and get it to production.
